...
const FEATURE_INFO = {
  ...
  std_out_value_eth:                      { label: 'Sent ETH Variance',           hint: 'Variability in outbound ETH amounts. Erratic sizes can indicate draining.' },
  min_in_value_eth:                       { label: 'Min Received (ETH)',          hint: 'Smallest inbound value. Near-zero = dust/lure transactions.' },
  median_inter_tx_minutes:                { label: 'Avg Gap Between Txs',         hint: 'Median minutes between txs. Near-zero = bot.' },
  std_inter_tx_minutes:                   { label: 'Tx Timing Variance',          hint: 'Variability in time between txs. Very low = robotic intervals.' },
